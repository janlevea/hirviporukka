...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 110, 541, 81))
        ...
        self.widget1.setGeometry(QtCore.QRect(340, 10, 211, 46))
        ...
        self.widget2.setGeometry(QtCore.QRect(200, 10, 131, 46))
        self.widget2.setObjectName("widget2")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.widget2)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.shotDateLabel = QtWidgets.QLabel(self.widget2)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.shotDateEdit = QtWidgets.QDateEdit(self.widget2)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.widget4.setGeometry(QtCore.QRect(10, 60, 181, 46))
        self.widget4.setObjectName("widget4")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.widget4)
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.ageGroupLabel = QtWidgets.QLabel(self.widget4)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.ageGroupComboBox = QtWidgets.QComboBox(self.widget4)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.widget5 = QtWidgets.QWidget(self.killPage)
        self.widget5.setGeometry(QtCore.QRect(200, 60, 131, 46))
        self.widget5.setObjectName("widget5")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.widget5)
        self.verticalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.genderLabel = QtWidgets.QLabel(self.widget5)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.genderLabel.setFont(font)
        self.genderLabel.setObjectName("genderLabel")
        self.verticalLayout_8.addWidget(self.genderLabel)
        self.genderComboBox = QtWidgets.QComboBox(self.widget5)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.widget6 = QtWidgets.QWidget(self.killPage)
        self.widget6.setGeometry(QtCore.QRect(10, 210, 751, 301))
        self.widget6.setObjectName("widget6")
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.widget6)
        ...
        self.killsKillsTableWidget = QtWidgets.QTableWidget(self.widget6)
        ...
        self.layoutWidget4 = QtWidgets.QWidget(self.sharePage)
        self.layoutWidget4.setGeometry(QtCore.QRect(10, 10, 751, 213))
        self.layoutWidget4.setObjectName("layoutWidget4")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.layoutWidget4)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.shareKillsLabel = QtWidgets.QLabel(self.layoutWidget4)
        self.shareKillsLabel.setObjectName("shareKillsLabel")
        self.verticalLayout_2.addWidget(self.shareKillsLabel)
        self.shareKillsTableWidget = QtWidgets.QTableWidget(self.layoutWidget4)
        ...
        self.layoutWidget5 = QtWidgets.QWidget(self.sharePage)
        self.layoutWidget5.setGeometry(QtCore.QRect(10, 230, 101, 41))
        self.layoutWidget5.setObjectName("layoutWidget5")
        self.verticalLayout_17 = QtWidgets.QVBoxLayout(self.layoutWidget5)
        self.verticalLayout_17.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_17.setObjectName("verticalLayout_17")
        self.label_2 = QtWidgets.QLabel(self.layoutWidget5)
        self.label_2.setObjectName("label_2")
        self.verticalLayout_17.addWidget(self.label_2)
        self.shareDateEdit = QtWidgets.QDateEdit(self.layoutWidget5)
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(120, 230, 171, 41))
        self.layoutWidget6.setObjectName("layoutWidget6")
        self.verticalLayout_18 = QtWidgets.QVBoxLayout(self.layoutWidget6)
        self.verticalLayout_18.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_18.setObjectName("verticalLayout_18")
        self.label_3 = QtWidgets.QLabel(self.layoutWidget6)
        self.label_3.setObjectName("label_3")
        self.verticalLayout_18.addWidget(self.label_3)
        self.portionComboBox = QtWidgets.QComboBox(self.layoutWidget6)
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(300, 230, 161, 41))
        ...
        self.amountLineEdit = QtWidgets.QLineEdit(self.layoutWidget7)
        ...
        self.layoutWidget8.setGeometry(QtCore.QRect(470, 230, 201, 41))
        self.layoutWidget8.setObjectName("layoutWidget8")
        self.verticalLayout_20 = QtWidgets.QVBoxLayout(self.layoutWidget8)
        self.verticalLayout_20.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_20.setObjectName("verticalLayout_20")
        self.label_5 = QtWidgets.QLabel(self.layoutWidget8)
        self.label_5.setObjectName("label_5")
        self.verticalLayout_20.addWidget(self.label_5)
        self.groupComboBox = QtWidgets.QComboBox(self.layoutWidget8)
        ...
        self.layoutWidget9 = QtWidgets.QWidget(self.licensePage)
        self.layoutWidget9.setGeometry(QtCore.QRect(10, 10, 151, 46))
        ...
        self.permitYearLabel = QtWidgets.QLabel(self.layoutWidget9)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.licenseYearLineEdit = QtWidgets.QLineEdit(self.layoutWidget9)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.layoutWidget10 = QtWidgets.QWidget(self.licensePage)
        self.layoutWidget10.setGeometry(QtCore.QRect(170, 10, 161, 47))
        ...
        self.licenseAnimalComboBox = QtWidgets.QComboBox(self.layoutWidget10)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.layoutWidget11.setGeometry(QtCore.QRect(340, 10, 141, 46))
        ...
        self.licenseAgeGroupComboBox = QtWidgets.QComboBox(self.layoutWidget11)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.layoutWidget12.setGeometry(QtCore.QRect(490, 10, 131, 46))
        ...
        self.licenseGenderComboBox = QtWidgets.QComboBox(self.layoutWidget12)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.layoutWidget13.setGeometry(QtCore.QRect(630, 10, 135, 47))
        ...
        self.licenseAmountLineEdit = QtWidgets.QLineEdit(self.layoutWidget13)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.layoutWidget14 = QtWidgets.QWidget(self.maintenancePage)
        self.layoutWidget14.setGeometry(QtCore.QRect(10, 10, 751, 501))
        ...
        self.groupBox_4 = QtWidgets.QGroupBox(self.layoutWidget14)
        self.groupBox_4.setObjectName("groupBox_4")
        self.gridLayout.addWidget(self.groupBox_4, 0, 0, 1, 1)
        self.groupBox = QtWidgets.QGroupBox(self.layoutWidget14)
        self.groupBox.setObjectName("groupBox")
        self.gridLayout.addWidget(self.groupBox, 0, 1, 1, 1)
        self.groupBox_3 = QtWidgets.QGroupBox(self.layoutWidget14)
        self.groupBox_3.setObjectName("groupBox_3")
        self.gridLayout.addWidget(self.groupBox_3, 1, 0, 1, 1)
        self.groupBox_2 = QtWidgets.QGroupBox(self.layoutWidget14)
